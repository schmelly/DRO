//import {STATE_ENTERING, STATE_OPERATION} from '../calculator/calculator.component';

import {CALCULATOR, DIRECTION, DISPLAY_STRING} from '../actions/calculator.actions';

/*export const S_INIT:string = 'S_INIT';
export const S_ENTER:string = 'S_FIRST_OPERAND';*/
